...
=======
  ...
  const githubAPI = githubToken ? new GitHubAPI(githubToken) : null;
>>>>>>> 3dceef5 (Made Some Changes in All Files)
...
<<<<<<< HEAD
=======
  const handleGitHubFileSelect = (file: GitHubFile, content: string) => {
...
<<<<<<< HEAD
          ...
          {sidebarVisible && (
            <div className="bg-slate-50 dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 overflow-hidden h-full">
              <FileExplorer />
=======
          {/* File Explorer / GitHub Repo Explorer */}
          {sidebarVisible && (
            <div className="bg-slate-50 dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 overflow-hidden h-full">
              {githubRepoMode && selectedGitHubRepo && selectedGitHubBranch && githubAPI ? (
                <GitHubRepoExplorer
                  githubAPI={githubAPI}
